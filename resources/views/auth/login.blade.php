...
<head>
    ...
    <title>Log in | Project Management System</title>
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="../../index2.html" class="h1"><b>PMS</b> SYSTEM</a>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('login') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input id="email" type="text" class="form-control @error('usrName') is-invalid @enderror"
                            name="usrName" value="{{ old('usrName') }}" placeholder="user name">
                ...
                <p class="mb-1">
                    <a href="forgot-password.html" style="display: none">I forgot my password</a>
                </p>
                <p class="mb-0">
